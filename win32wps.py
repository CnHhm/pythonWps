...
et = win32com.client.Dispatch("Word.Application")
et.Visible = True # 确定ET是否可见
fileExcel = r'D:\project\pythonWps\test.xls'
fileWord = r'D:\project\pythonWps\test.doc'
# 打开wps表格文件
# wb = et.Workbooks.Open(fileWord)
wb = et.Documents.Open(fileWord)
# newdoc = et.Documents.Add()
# # # 新建一个wps工作簿
# # # wb = et.Workbooks.Add()
# # 打开wps表格文件中的第一张表
# sht = wb.Worksheets(1)
